...
function App() {
  ...
  // const orderProduct = async (index) => {
  //   try {
  //     await contract.methods.orderProduct(index).send({ from: address });
  //   } catch (error) {
  //     console.log(error);
  //   } finally {
  //     getProducts();
  ...
  const orderProduct = async (_index) => {
    ...
    try {
      ...
      getBalance();
      alert(
        `you have successfully ordered ${products[_index].brand} , the product it will be delivered in ${products[_index].deliveredWithin} `
      );
    } catch (error) {
      alert(error);
    }
    ...
    <>
      ...
      <section id="order_product">
        ...
        <div className="d-flex justify-content-around flex-wrap">
          {/* <ProductCard orderProduct={orderProduct} /> */}
